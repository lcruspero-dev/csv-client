        ...
        <CardContent className="p-3">
          <div className="space-y-4">
            ...
            <div>
              ...
              <Separator className="mb-1" />
              <div className="grid grid-cols-1 md:grid-cols-3 gap-x-2 gap-y-0">
                <InfoItem label="User ID" value={userData?.userId} />
                <InfoItem
                  label="Created At"
                  value={new Date(userData?.createdAt).toLocaleString("en-PH", {
                ...
                <InfoItem
                  label="Updated At"
                  value={new Date(userData?.updatedAt).toLocaleString("en-PH", {
                    timeZone: "Asia/Manila",
                    year: "numeric",
                    month: "long",
                    day: "numeric",
